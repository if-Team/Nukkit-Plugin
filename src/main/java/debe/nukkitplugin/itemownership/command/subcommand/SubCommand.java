...
public abstract class SubCommand{
	protected ItemOwnershipCommand mainCommand;
	...
	public SubCommand(ItemOwnershipCommand mainCommand, String name, String permission){
		this.mainCommand = mainCommand;
		this.name = name;
		this.permission = permission;
	}

	public SubCommand(ItemOwnershipCommand mainCommand, String name, String permission, String usage, int needArgCount){
